  ...
  <form action="" method="POST">
    <ul>
      ...
      <li>
        <label>
          Jurusan :
          <input type="text" name="jurusan" autofocus autocomplete="off" required>
        </label>
      </li>
      <li>
        <label>
          Gambar :
          <input type="text" name="gambar" autofocus autocomplete="off" required>
        </label>
      </li>
      <li>
        <button type="submit" name="tambah">Tambah Data!</button>
        <button><a href="latihan3.php">Kembali</a></button>
      </li>
    </ul>
